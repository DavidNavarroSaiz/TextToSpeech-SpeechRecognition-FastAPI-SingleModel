...
const modelSelect = document.getElementById('model-select');
        ...
        // Define available models for each language
...
const availableModels_TTS = {
    english: [ 'gtts','pytts','Azure'],
    spanish: ['gtts','Azure']
    // Add more languages and their respective models here
};

// Function to update the model options based on the selected language
function updateModelOptions() {
    const selectedLanguage = languageSelect.value;
    const models = availableModels[selectedLanguage];
    const models_tts = availableModels_TTS[selectedLanguage];

    // Clear existing options
    modelSelect.innerHTML = '';
    modelSelect_tts.innerHTML = '';
    ...
    models_tts.forEach(model_tts => {
        const option = document.createElement('option');
        option.value = model_tts;
        option.textContent = model_tts;
        modelSelect_tts.appendChild(option);
    });
}
...
// Initial update of model options based on the default selected language
updateModelOptions();
